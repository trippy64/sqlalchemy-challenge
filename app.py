...
def precipitation():
    ...
    results = session.query(HI_Measurement.date, HI_Measurement.prcp).all()
...
def stations():
    ...
    results = session.query(HI_Station.station, HI_Station.name).all()
...
def tobs():
    ...
    results = session.query(HI_Measurement.tobs, HI_Measurement.date).filter(HI_Measurement.date >= query_date).all()
...
def start(start):
    ...
    results = session.query(func.min(HI_Measurement.tobs), func.avg(HI_Measurement.tobs), func.max(HI_Measurement.tobs)).filter(HI_Measurement.date >= start_dt).all()
...
def start_end(start, end):
    ...
    # query data for the start date value
    results = session.query(func.min(HI_Measurement.tobs), func.avg(HI_Measurement.tobs), func.max(HI_Measurement.tobs)).filter(HI_Measurement.date >= start_dt).filter(HI_Measurement.date <= end_dt)
